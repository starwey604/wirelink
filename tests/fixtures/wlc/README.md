...
The current artifacts use ABI 26. Automatic endpoint sessions and managed RPC v2
do not alter this fixture's mapped RPC, codec bytes, or frozen frame vectors.
