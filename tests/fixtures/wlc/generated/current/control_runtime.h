...
#define CONTROL_CODEGEN_CONTRACT_MAJOR 0U
#define CONTROL_CODEGEN_CONTRACT_MINOR 8U
#if !WIRELINK_CODEGEN_CONTRACT_ACCEPTS(CONTROL_CODEGEN_CONTRACT_MAJOR, CONTROL_CODEGEN_CONTRACT_MINOR)
