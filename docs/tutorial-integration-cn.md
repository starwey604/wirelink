...
WLC 只在构建时运行；本轮需使用[安装篇](installation-cn.md)锁定的 WLC 0.8.0 与
生成 ABI 32。
...
- 想设计更多消息：读 [schema](schema-v1-cn.md) 与 [WLC](https://github.com/starwey604/wlc/blob/c6b6a8fa560a15c45d564aad0afd197b13682de8/README-cn.md)。
